...
>
                ...
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="w-full lg:w-1/4 flex justify-end gap-2"">
                        <x-link 
                            ...
                            intent="secondary"
                            href="#"
                            href="{{ route(module_release_1_meta('kebab').'.password.change') }}"
                        >
                            Change Password
                        </x-link>
                         ...
                         <x-link 
                            ...
                            intent="secondary"
                            href="#"
                            href="{{ route(module_release_1_meta('kebab').'.password.confirm') }}"
                        >
    ...
    >
        <form 
            action="{{ route(module_release_1_meta('kebab').'.'.$role.'.profile-image.update', auth(module_release_1_meta('snake').'_web')->user()->id) }}" 
            method="POST" 
    ...
    <x-modal 
        ...
        maxWidth="md"
    >
        <form action="{{ route(module_release_1_meta('kebab').'.'.$role.'.profile-image.destroy') }}" method="POST">
            @csrf
            @method('DELETE')
    ...
    >
        <form 
            action="{{ route(module_release_1_meta('kebab').'.'.$role.'.profile.update', $user->slug) }}" 
            method="POST" 
            enctype="multipart/form-data" 
        >
            @csrf
