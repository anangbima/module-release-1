<x-module-release-1::auth-layout :title="__('Password Confirmation | Module Release 1')">
   ...
   <div class="rounded-xl pb-8 pt-6 px-8 shadow-2xl bg-white dark:bg-slate-900 animate-scale-in max-w-xl">
        <div>
            ...
            <form action="{{ route(module_release_1_meta('kebab').'.password.confirm') }}" method="POST">
                @csrf
