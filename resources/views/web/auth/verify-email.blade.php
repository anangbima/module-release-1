<x-module-release-1::auth-layout :title="__('Verify Your Email Address | Module Release 1')">
    ...
    <div class="rounded-xl pb-8 pt-6 px-8 shadow-2xl bg-white dark:bg-slate-900 animate-scale-in max-w-xl">
        <div>
            ...
            <form method="POST" action="{{ route(module_release_1_meta('kebab').'.verification.send') }}" class="mt-8">
                @csrf
                <x-link 
                    tag="button" 
                    type="submit" 
