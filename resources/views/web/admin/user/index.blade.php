...
>   
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
        ...
        {{-- Redirect to Role --}}
        <a href="{{ route(module_release_1_meta('kebab').'.admin.roles.index') }}" 
    ...
    <div class="mb-2 flex justify-between items-center">
        <div>
            <x-link 
                ...
                size="md"
                href="{{ route(module_release_1_meta('kebab').'.admin.users.create') }}"
            >
                <x-slot:iconBefore>
                ...
                <tr class="h-18">
                    ...
                    <td x-data="{ isOpen: false }" class="relative">
                        ...
                        >
                            <div class="p-2">
                                <a 
                                    href="{{ route(module_release_1_meta('kebab').'.admin.users.show', $user->slug) }}"
                                ...
                                <a 
                                    href="{{ route(module_release_1_meta('kebab').'.admin.users.edit', $user->slug) }}"
                                    class="flex items-center w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded"
                                >
    ...
    >
        <div class="pb-4 space-y-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.users.export', ['type' => 'xlsx']) }}" 
                ...
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.users.export', ['type' => 'csv']) }}" 
                    class="bg-white dark:bg-slate-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
                ...
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.users.export', ['type' => 'pdf']) }}" 
                    class="bg-white dark:bg-slate-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
                ...
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.users.export', ['type' => 'docx']) }}" 
                    class="bg-white dark:bg-slate-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
                ...
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.users.export', ['type' => 'json']) }}" 
                    class="bg-white dark:bg-slate-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
    ...
    <x-modal name="modal-import" title="Import Data User" maxWidth="2xl">
        <form 
            action="{{ route(module_release_1_meta('kebab').'.admin.users.import') }}" 
            method="POST" 
    ...
    >
        ...
        >
            ...
            <div class="w-full flex justify-end gap-3 mt-4">
                ...
                <form 
                    x-bind:action="`{{ route(module_release_1_meta('kebab').'.admin.users.status.update', ['user' => ':id']) }}`.replace(':id', selectedId)" 
                    method="POST"
                >
                    @csrf
                    @method('PUT')
    ...
    >
        ...
        >
            ...
            <div class="w-full flex justify-end gap-3 mt-4">
                ...
                <form 
                    x-bind:action="`{{ route(module_release_1_meta('kebab').'.admin.users.destroy', ['user' => ':id']) }}`.replace(':id', selectedId)" 
                    method="POST"
                >
                    @csrf
                    @method('DELETE')
