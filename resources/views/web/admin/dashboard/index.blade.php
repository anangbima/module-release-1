...
>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 mt-2">
        {{-- Total users card --}}
        <a href="{{ route(module_release_1_meta('kebab').'.admin.users.index') }}"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
        ...
        <div class="lg:col-span-1">
            <div class="flex justify-between items-center">
                ...
                <a class="text-xs" href="{{ route(module_release_1_meta('kebab').'.admin.logs.index') }}">
                    View All
                </a>
            </div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <div class="text-sm leading-relaxed">
                                    <div class="flex items-center gap-2 flex-wrap">
                                        ...
                                        @php
                                            $color = module_release_1_action_color($log->action);
                                        @endphp

                                        <x-badge 
                                            text="{{ module_release_1_format_action($log->action) }}" 
                                            size="xs" 
                                            color="{{ $color }}"  
                                        />
                                    </div>
