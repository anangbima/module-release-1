    ...
    >
        <div class="pb-4 space-y-4">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-3">
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.logs.export', ['type' => 'xlsx']) }}" 
                ...
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.logs.export', ['type' => 'csv']) }}" 
                    class="bg-white dark:bg-slate-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
                ...
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.logs.export', ['type' => 'pdf']) }}" 
                    class="bg-white dark:bg-slate-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
                ...
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.logs.export', ['type' => 'docx']) }}" 
                    class="bg-white dark:bg-slate-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
                ...
                <a 
                    href="{{ route(module_release_1_meta('kebab').'.admin.logs.export', ['type' => 'json']) }}" 
                    class="bg-white dark:bg-slate-900 flex items-center justify-center border border-gray-300 dark:border-gray-700 rounded-lg px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-800 transition"
                >
