...
>
    ...
    <div class="mb-2">
        <x-link 
            ...
            size="md"
            href="{{ route(module_release_1_meta('kebab').'.admin.permissions.create') }}"
        >
            <x-slot:iconBefore>
                ...
                <tr>
                    ...
                    <td x-data="{ isOpen: false }" class="relative">
                        ...
                        >
                            <div class="p-2">
                                <a 
                                    href="{{ route(module_release_1_meta('kebab').'.admin.permissions.show', $permission->id) }}"
                                ...
                                <a 
                                    href="{{ route(module_release_1_meta('kebab').'.admin.permissions.edit', $permission->id) }}"
                                    class="flex items-center w-full px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded"
                                >
    ...
    >
        ...
        >
            ...
            <div class="w-full flex justify-end gap-3 mt-4">
                ...
                <form 
                    x-bind:action="`{{ route(module_release_1_meta('kebab').'.admin.permissions.destroy', ['permission' => ':id']) }}`.replace(':id', selectedId)" 
                    method="POST"
                >
                    @csrf
                    @method('DELETE')
