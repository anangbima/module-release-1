...
>
    ...
    <div class="mb-4">
        <x-link 
            ...
            size="md" 
            href="{{ route(module_release_1_meta('kebab').'.admin.api-clients.create') }}"
        >
            <x-slot:iconBefore>
                ...
                <tr>
                    ...
                    <td x-data="{ isOpen: false }" class="relative">
                        ...
                        >
                            <div class="p-2">
                                <a 
                                    href="{{ route(module_release_1_meta('kebab').'.admin.api-clients.show', $apiClient->slug) }}"
    ...
    >
        ...
        >
            ...
            <div class="w-full flex justify-end gap-3 mt-4">
                ...
                <form 
                    x-bind:action="`{{ route(module_release_1_meta('kebab').'.admin.api-clients.destroy', ['api_client' => ':id']) }}`.replace(':id', selectedId)" 
                    method="POST"
                >
                    @csrf
                    @method('DELETE')
    ...
    >
        ...
        >
            ...
            <div class="w-full flex justify-end gap-3 mt-4">
                ...
                <form 
                    x-bind:action="`{{ route(module_release_1_meta('kebab').'.admin.api-clients.status.update', ['api_client' => ':id']) }}`.replace(':id', selectedId)" 
                    method="POST"
                >
                    @csrf
                    @method('PUT')
