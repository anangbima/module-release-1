        ...
        @php
            ...
            $menuItems = [
                [
                    ...
                    'route' => module_release_1_meta('kebab').'.user.index',
                ...
                [
                    'label' => 'My Log',
                    'url' => route(module_release_1_meta('kebab').'.user.logs.index'),
                    'route' => module_release_1_meta('kebab').'.user.logs.*',
            ...
            >
                ...
                <x-slot:actions>
                    ...
                    <x-notification-button 
                        ...
                        :urlAllNotification="route(module_release_1_meta('kebab').'.user.notifications.index')" 
                    />
                    ...
                    <x-profile-button 
                        ...
                        :account_url="route(module_release_1_meta('kebab').'.user.profile.index')" 
                        :setting_url="'#'" 
