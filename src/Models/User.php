...
use Modules\ModuleRelease1\Models\BaseAuthModel;
...
use Modules\ModuleRelease1\Database\Factories\UserFactory;
use Modules\ModuleRelease1\Notifications\ResetPasswordNotification;
use Modules\ModuleRelease1\Notifications\VerifyEmailNotification;
use Modules\ModuleRelease1\Traits\HasMedia;
...
class User extends BaseAuthModel implements AuthMustVerifyEmail, JWTSubject
{
    ...
    protected $guard_name = 'module_release_1_web';
