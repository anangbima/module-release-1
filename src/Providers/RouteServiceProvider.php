...
use Modules\ModuleRelease1\Http\Middleware\EnsureAuthenticated;
...
class RouteServiceProvider extends ServiceProvider
{
    ...
    {   
        ...
        Route::middlewareGroup('module_release_1-auth', [
            EnsureAuthenticated::class . ':module_release_1_web',
        ]);
        ...
        $this->loadRoutesFromDirectory(
            ...
            middleware: ['web'],
            prefix: 'module-release-1',
            name: 'module-release-1'
        );
        ...
        $this->loadRoutesFromDirectory(
            ...
            middleware: ['api'],
            prefix: 'module-release-1/api',
            name: 'module-release-1.api'
        );

        // external api routes with custom module guard
        $this->loadRoutesFromDirectory(
            directory: __DIR__ . '/../../routes/external-api',
            middleware: ['api', 'module_release_1.verify_api_client'],
            prefix: 'module-release-1/external-api',
            name: 'module-release-1.external-api'
        );

        // channel routes
        $this->loadChannelRoutes(
            directory: __DIR__ . '/../../routes/channels',
            middleware: ['web', 'auth:module_release_1_web'],
            prefix: 'module-release-1'
        );
    }
