...
class MakeServiceCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Generate a new service class in the Module Release 1 module';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-service
    ...
    public function handle(): int
    {
        ...
        $namespace = "Modules\\ModuleRelease1\\Services" . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('Modules/module-release-1/src/Services' . ($subPath ? '/' . $subPath : ''));
