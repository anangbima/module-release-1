...
{
    protected $signature;
    protected $description = 'Generate a new API resource for Module Release 1';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-resource
    ...
    public function handle()
    {
        ...
        $namespace = 'Modules\\ModuleRelease1\\Http\\Resources' . ($subNamespace ? "\\{$subNamespace}" : '');
        $targetPath = base_path("Modules/module-release-1/src/Http/Resources"
            . ($subPath ? "/{$subPath}" : '')
            . "/{$className}.php");
