...
class MigrateCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Run migrations for Module Release 1';
    ...
    public function __construct()
    {
        ...
        $this->signature = 'module:modulerelease1:migrate
    ...
    public function handle()
    {
        ...
        $connection = config('module_release_1.database.database_connection', 'module_release_1');
        $database = config('module_release_1.database.connection.database', 'module_release_1');
        ...
        $realMigrationPath = base_path('modules/module-release-1/src/Database/Migrations');
