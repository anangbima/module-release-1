...
{
    protected $signature;
    protected $description = 'Generate a new notification class using stub for Module Release 1';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-notification
    ...
    public function handle()
    {
        ...
        $targetPath = base_path('Modules/module-release-1/src/Notifications/'.$className.'.php');
