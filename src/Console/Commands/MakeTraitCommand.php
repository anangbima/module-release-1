...
class MakeTraitCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Generate a new traits class in the Module Release 1 module';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-trait
    ...
    public function handle(): int
    {
        ...
        $namespace = "Modules\\ModuleRelease1\\Traits" . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('Modules/module-release-1/src/Traits' . ($subPath ? '/' . $subPath : ''));
