...
class MakeRequestCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Generate a new Form Request file in the Module Release 1 module';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-request
    ...
    public function handle(): int
    {
        ...
        $namespace = "Modules\\ModuleRelease1\\Http\\Requests" . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('Modules/module-release-1/src/Http/Requests' . ($subPath ? '/' . $subPath : ''));
