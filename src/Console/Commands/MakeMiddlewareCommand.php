...
{
    protected $signature;
    protected $description = 'Generate a new middleware for Module Release 1';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-middleware
    ...
    public function handle()
    {
        ...
        $targetPath = base_path('Modules/module-release-1/src/Http/Middleware/'.$className.'.php');
