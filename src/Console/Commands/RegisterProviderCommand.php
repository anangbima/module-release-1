...
class RegisterProviderCommand extends Command
{
     ...
     */
    protected $signature;
    protected $description = 'Register the Module Release 1 service provider';
    ...
    public function __construct()
    {
        ...
        $this->signature = 'module:modulerelease1:register-provider';
    ...
    {
        $provider = 'Modules\ModuleRelease1\Providers\ModuleServiceProvider';
