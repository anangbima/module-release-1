...
{
    protected $signature;
    protected $description = 'Generate a new seeder for Module Release 1';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-seeder
    ...
    public function handle()
    {
        ...
        $namespace = 'Modules\\ModuleRelease1\\Database\\Seeders' . ($subNamespace ? "\\{$subNamespace}" : '');
        $targetPath = base_path("Modules/module-release-1/src/Database/Seeders"
            . ($subPath ? "/{$subPath}" : '')
            . "/{$className}.php");
