...
{
    protected $signature;
    protected $description = 'List all routes for Module Release 1 module';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:route-list';
        parent::__construct();
    }
    ...
    public function handle()
    {
        $routes = collect(Route::getRoutes())->filter(function ($route) {
            return str_contains($route->getName(), 'module-release-1.')
                || str_contains($route->uri(), 'module-release-1');
        });
