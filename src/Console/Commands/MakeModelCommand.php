...
{
    protected $signature;
    protected $description = 'Generate a new model and migration for Module Release 1';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-model
    ...
    public function handle(): int
    {
        ...
        $modelDir = base_path('Modules/module-release-1/src/Models');
        $migrationDir = base_path('Modules/module-release-1/src/Database/Migrations');
        $moduleNamespace = 'Modules\\ModuleRelease1\\';
        ...
        $modelStub = str_replace(
            ...
            ['Modules\\ModuleRelease1\\Models', $modelName, 'module_release_1', $tableName, $tableName],
            $modelStub
        );
        ...
        $migrationStub = str_replace(
            ...
            [$migrationClass, module_release_1_meta('snake'), 'table_name', $tableName, $moduleNamespace],
            $migrationStub
        );        
        ...
        // ==== CONFIG OVERRIDE ====
        $configFolder = base_path('Modules/module-release-1/config/'.$tableName);
