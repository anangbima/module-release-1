...
class MakeComponentCommand extends Command
{
     ...
     */
    protected $description = 'Generate a new component file in the Module Release 1 module';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-component
    ...
    public function handle()
    {
        ...
        $namespace = 'Modules\\ModuleRelease1\\View\\Components' . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('modules/module-release-1/src/View/Components' . ($subPath ? '/' . $subPath : ''));
