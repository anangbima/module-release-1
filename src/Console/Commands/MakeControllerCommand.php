...
class MakeControllerCommand extends Command
{
     ...
     */
    protected $description = 'Generate a new controller file in the Module Release 1 module';

    public function __construct()
    {
        $this->signature = 'module:modulerelease1:make-controller
    ...
    public function handle()
    {
        ...
        $namespace = 'Modules\\ModuleRelease1\\Http\\Controllers' . ($namespaceSuffix ? "\\$namespaceSuffix" : '');
        $basePath = base_path('Modules/module-release-1/src/Http/Controllers' . ($subPath ? '/' . $subPath : ''));
        $filePath = "$basePath/{$className}.php";
        $controllerNamespace = 'Modules\\ModuleRelease1\\Http\\Controllers';
