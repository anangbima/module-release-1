...
use Modules\ModuleRelease1\Http\Resources\Shared\AuthenticatedUserResource;
...
class AuthenticationApiService
{
    ...
    public function login(LoginRequest $request)
    {
        ...
        try {
            if (!$token = auth('module_release_1_api')->attempt($credentials)) {
                return [
                    'status' => 'error',
                    'code' => 401,
        ...
        $user = auth('module_release_1_api')->user();
    ...
    {
        $status = Password::broker(module_release_1_meta('snake') . '_users')->reset(
            $credentials,
