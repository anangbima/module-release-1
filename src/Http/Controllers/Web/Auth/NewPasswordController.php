...
use Modules\ModuleRelease1\Http\Requests\Web\Auth\NewPasswordRequest;
...
class NewPasswordController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view(module_release_1_meta('kebab').'::web.auth.reset-password', $data);
    }
    ...
    public function store(NewPasswordRequest $request)
    {
        ...
        return $status == Password::PASSWORD_RESET
                    ? view(module_release_1_meta('kebab').'::web.auth.reset-password-success', ['status' => __($status)])
