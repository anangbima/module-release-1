...
use Modules\ModuleRelease1\Exporters\LogActivityExporter;
...
use Modules\ModuleRelease1\Services\Shared\LogActivityService as SharedLogActivityService;
...
class LogActivityController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.log-activity.index', $data);
    }
    ...
    public function show(LogActivity $log)
    {
        ...
        return view(module_release_1_meta('kebab').'::web.shared.log-activity.show', $data);
    }
    ...
    public function export(string $type)
    {
        ...
        $fileName = module_release_1_fileName('log_activities_export', $type);
        $pdfView = module_release_1_meta('kebab').'::pdf.log-activities';
