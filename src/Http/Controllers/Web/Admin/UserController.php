...
use Modules\ModuleRelease1\Exporters\UserExporter;
use Modules\ModuleRelease1\Http\Controllers\Controller;
use Modules\ModuleRelease1\Http\Requests\Web\Admin\StoreUserRequest;
use Modules\ModuleRelease1\Http\Requests\Web\Admin\UpdateUserRequest;
use Modules\ModuleRelease1\Http\Requests\Web\Shared\ImportRequest;
use Modules\ModuleRelease1\Importers\UserImporter;
...
class UserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.user.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.user.create', $data);
    }
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        return redirect()->route(module_release_1_meta('kebab').'.admin.users.index')
    ...
    public function show(User $user)
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.user.show', $data);
    }
    ...
    public function edit(User $user)
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.user.edit', $data);
    }
    ...
    */
    public function export(string $type)
    {
        ...
        $fileName = module_release_1_fileName('users_export', $type);
        $pdfView = module_release_1_meta('kebab').'::pdf.users';
