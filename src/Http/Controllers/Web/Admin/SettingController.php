...
use Modules\ModuleRelease1\Services\Admin\SettingService;
...
class SettingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.setting.index', $data);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect()->route(module_release_1_meta('kebab').'.admin.settings.index')
