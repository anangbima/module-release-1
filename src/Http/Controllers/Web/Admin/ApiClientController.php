...
use Modules\ModuleRelease1\Http\Requests\Web\Admin\StoreApiClientRequest;
...
class ApiClientController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.api-client.index', $data);
    }
    ...
    public function create()
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.api-client.create', $data);
    }
    ...
    public function store(StoreApiClientRequest $request)
    {
        ...
        return redirect()->route(module_release_1_meta('kebab').'.admin.api-clients.index')
    ...
    public function show(ApiClient $apiClient)
    {
        ...
        return view(module_release_1_meta('kebab').'::web.admin.api-client.show', $data);
    }
