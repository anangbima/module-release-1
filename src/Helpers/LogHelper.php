...
if (!function_exists('module_release_1_format_action')) {
    function module_release_1_format_action(string $action): string
    {
...
if (!function_exists('module_release_1_action_color')) {
    function module_release_1_action_color(string $action): string
    {
        return match (true) {
